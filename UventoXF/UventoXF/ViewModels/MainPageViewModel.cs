...
namespace UventoXF.ViewModels
{
    public class MainPageViewModel : BaseViewModel
    {
        ...
        public MainPageViewModel(INavigation navigation)
        {
            ...
            NavigateToProfilePageCommand = new Command(async () => await ExecuteNavigateToProfilePageCommand());
        ...
        public Command NavigateToProfilePageCommand { get; }

        private async Task ExecuteNavigateToProfilePageCommand()
        {
